...
videoProxy = ALProxy("ALVideoDevice", naoIP, naoPort)
...
camID = videoProxy.subscribeCamera(subscriberID, vision_definitions.kTopCamera, vision_definitions.kVGA, vision_definitions.kRGBColorSpace, fps)
...
JointControl(clientID,motionProxy,0,Body,videoProxy,camID,'NAO_vision1', sample_time)
